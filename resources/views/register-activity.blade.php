...
<body>
  ...
  <div style="flex:1; padding: 32px; max-width:900px; margin-left: 25%; width:100%;">
    ...
    <div
      style="background:white; border-radius:20px; box-shadow:var(--card-shadow); padding:36px; width:100%; max-width:700px;">
      ...
      <form action="{{ route('activity.register', $activity->id) }}" method="POST" style="margin-top:28px;">
        ...
        <div class="checkbox-row">
          ...
          <label for="tos-reg">I've read the
            <a href="#" onclick="openModal('modal-activity-details'); return false;">Details</a>
            and <a href="#">Available</a> for this activity
          </label>
        </div>
  ...
  <div class="modal-overlay" id="modal-activity-details">
    <div class="modal" style="max-width:560px; max-height:80vh; overflow-y:auto;">
      ...
      <p style="font-size:13px; color:#4b5563; line-height:1.7; margin-bottom:12px;">Lorem ipsum dolor sit amet,
      ...
      <p style="font-size:13px; color:#4b5563; line-height:1.7;">Lorem ipsum dolor sit amet, consectetur adipiscing
        elit. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</p>
    </div>
  </div>
