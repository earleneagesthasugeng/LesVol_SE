  ...
  <div style="background:white; border-radius:20px; box-shadow:var(--card-shadow); padding:36px; width:100%; max-width:700px;">
    ...
    <div style="margin-top:28px;">
      <div class="form-group">
        <label>Name</label>
        <input class="form-input" type="text" placeholder="Type Name Here">
      </div>
      <div class="form-group">
        <label>Phone Number</label>
        <input class="form-input" type="tel" placeholder="Type Phone Number Here">
      </div>
      <div class="form-group">
        <label>Email</label>
        <input class="form-input" type="email" placeholder="Type Email Here">
      </div>
      <div class="checkbox-row">
        <input type="checkbox" id="tos-reg">
      ...
      <div style="text-align:center; margin-top:16px;">
        <button class="btn btn-primary btn-lg" style="padding:14px 60px;" onclick="openModal('modal-register-success')">Register</button>
      </div>
    </div>
  </div>
</div>
