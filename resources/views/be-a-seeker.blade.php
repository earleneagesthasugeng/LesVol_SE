...
<div class="main-content" style="max-width: 800px;">
  ...
  <div style="text-align: center; margin-bottom: 40px;">
    ...
    <p style="color: var(--text); font-size: 14px; font-weight: 500;">Be the one to seek volunteers and help the community to be a better place!</p>
  </div>

  <div class="auth-card" style="max-width: 700px; margin: 0 auto; padding: 40px; position: relative; border-radius: 30px;">
  ...
  <div style="text-align: center;">
    ...
    <div class="upload-img-box" id="dropzone" style="background: #f3f4f6; border: 2px dashed #d1d5db; height: 260px; flex-direction: column; gap: 20px; border-radius: 20px; margin-bottom: 30px; overflow: hidden; position: relative;">
      
      <div id="upload-placeholder" style="display: flex; flex-direction: column; align-items: center; gap: 20px;">
        <svg width="100" height="100" viewBox="0 0 24 24" fill="none" stroke="#d1d5db" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
      ...
      <img id="image-preview" src="#" alt="Preview" style="display: none; width: 100%; height: 100%; object-fit: contain; padding: 10px;">
    </div>

    <button class="btn-danger" id="upload-trigger" style="padding: 12px 50px; font-size: 16px;">Upload</button>
  </div>
</div>
</div>
...
<div class="modal-overlay" id="modal-register-success">
  <div class="modal" style="text-align:center; max-width:420px; padding:40px 32px;">
    ...
    <a href="/" style="display:inline-block; margin-top:20px; color:var(--red-btn); font-weight:600; font-size:14px;">Seek all the activities →</a>
  </div>
</div>
